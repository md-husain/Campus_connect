    ...
    <footer className="bg-white border-t border-gray-200 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-lg font-bold text-gray-900 mb-4">CampusConnect</h3>
            <p className="text-sm text-gray-600">
              Connecting students, faculty, and staff for a better campus experience.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/help" className="text-sm text-gray-600 hover:text-blue-600">Help Center</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/resources" className="text-sm text-gray-600 hover:text-blue-600">Study Materials</a></li>
              <li><a href="/events" className="text-sm text-gray-600 hover:text-blue-600">Campus Events</a></li>
              <li><a href="/courses" className="text-sm text-gray-600 hover:text-blue-600">Courses</a></li>
              <li><a href="/groups" className="text-sm text-gray-600 hover:text-blue-600">Groups</a></li>
            </ul>
          </div>
